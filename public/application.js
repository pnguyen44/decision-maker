...
var listsUi = __webpack_require__(21);
...
var onCreateList = function onCreateList(event) {
  ...
  if (list.name.trim().length > 0) {
    listsApi.create(list.name).then(listsUi.onCreateSuccess).catch(listsUi.onError);
  }
};
var getLists = function getLists() {
  listsApi.index().then(listsUi.getListsSuccess).catch(listsUi.onError);
};
var getOneList = function getOneList(id) {
  listsApi.show(id).then(listsUi.getOneListSuccess).catch(listsUi.onError);
};

var updateList = function updateList(name, id) {
  listsApi.update(name, id).then(listsUi.onUpdateSuccess).catch(listsUi.onError);
};

var onDeleteList = function onDeleteList(id) {
  listsApi.destroy(id).then(listsUi.onDeleteSuccess(id)).catch(listsUi.onError);
};

var deleteListClickHander = function deleteListClickHander() {
...
var editListClickHander = function editListClickHander() {
  $('.btn-edit-list').on('click', function () {
    if (store.isSignedIn === true) {
      var listId = $(this).attr('data-list-edit-id');
      store.listId = listId;
      var listName = $(this).attr('data-list-edit-name');
...
var listsEventsHandler = function listsEventsHandler() {
  editListClickHander();
...
var update = function update(name, id) {
  return $.ajax({
    url: config.apiOrigin + '/lists/' + id,
    cache: false,
    method: 'PATCH',
...
var itemsApi = __webpack_require__(22);
var itemsUi = __webpack_require__(23);
var getFormFields = __webpack_require__(6);
...
var onCreateItem = function onCreateItem(e) {
  e.preventDefault();
  var data = getFormFields(this);
  var item = data.item;
  itemsApi.create(item.name, item.mark, item.list_id).then(itemsUi.onCreateSuccess).catch(itemsUi.onError);
};

var createOneItem = function createOneItem(name, mark, listId) {
  mark = false;
  itemsApi.create(name, mark, listId).then(itemsUi.onCreateSuccess).catch(itemsUi.onError);
};

var getItems = function getItems() {
  itemsApi.index().then(itemsUi.getItemsSuccess).catch(itemsUi.onError);
};
var getOneItem = function getOneItem(id) {
  itemsApi.show(id).then(itemsUi.getOneItemSuccess).catch(itemsUi.onError);
};

var onUpdateItem = function onUpdateItem(name, mark, itemId, listId) {
  itemsApi.update(name, mark, itemId, listId).then(itemsUi.onUpdateSuccess).catch(itemsUi.onError);
};

var onDeleteItem = function onDeleteItem(id) {
  itemsApi.destroy(id).then(itemsUi.onDeleteSuccess(id)).catch(itemsUi.onError);
};

var onChooseItem = function onChooseItem(items) {
  var unMarkedItems = items.filter(function (items) {
    return items.mark === false;
  });
  var numOfItems = unMarkedItems.length;
  if (numOfItems > 0) {
    var itemPosition = Math.floor(Math.random() * numOfItems) + 1;
    var choosenItem = unMarkedItems[itemPosition - 1].name;
    $('#item-choose-list-id-' + store.chooseItemListId).text(choosenItem);
  }
};

var editItemClickHandler = function editItemClickHandler() {
...
var chooseItemClickHandler = function chooseItemClickHandler() {
  $('.btn-choose-item').on('click', function () {
    if (store.isSignedIn === true) {
      store.chooseItemListId = $(this).attr('data-choose-item-list-id');
      listsApi.show(store.chooseItemListId).then(function (data) {
...
var displayChosenItem = function displayChosenItem(data) {
...
var addItemClickHandler = function addItemClickHandler() {
  $('.btn-add-item').on('click', function (e) {
    e.preventDefault();
    if (store.isSignedIn === true) {
      var listId = $(this).attr('data-item-name-list-id');
      var inputBox = '#item-name-list-id-' + listId;
      var itemName = String($(inputBox).val());
      $(inputBox).val('');
...
var deleteItemClickHander = function deleteItemClickHander() {
...
var checkBoxClickHander = function checkBoxClickHander() {
  $('.checkBox').on('click', function () {
    if (store.isSignedIn === true) {
      var mark = $(this).is(':checked');
      var itemName = $(this).attr('data-item-name-id');
      var itemId = $(this).attr('data-checkbox-item-id');
...
var itemsEventsHander = function itemsEventsHander() {
  addItemClickHandler();
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- <div class=\"col-xs-12 col-sm-6 col-md-4 col-lg-3 box\"> -->\n  <div class=\"list-name\" id='list-id-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "'>\n\n    <div class=\"btn-list\">\n      <button type=\"button\" class=\"btn-edit-list btn-1 btn-default btn-xs\" id=\"btn-edit-list-id-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-list-edit-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-list-edit-name=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.name : stack1), depth0))
    + "\">Edit</button>\n      <button type=\"button\" class=\"btn-delete-list btn-1 btn-danger btn-xs\" id=\"btn-delete-list-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-list-delete-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">X</button>\n    </div>\n    <h2 id=\"list-name-id-"
    ...
    + "\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h2>\n  </div>\n  <!-- decide button -->\n  <button type=\"button\" class=\"btn-choose-item pull-right btn-primary btn-xs\" data-choose-item-list-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-choose-items=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.items : stack1), depth0))
    + "\">Decide</button>\n  <div type=\"text\" name=\"item[name]\" id='item-choose-list-id-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "' class=\"choosen-item\" placeholder=\"\"></div>\n  <div class=\"line-under-decide\"></div>\n  <form class=\"add-item-form\">\n    <!-- <div class='choose'> -->\n    <input type=\"text\" name=\"item[name]\" class=\"item-input\" id='item-name-list-id-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "' placeholder=\"Enter Item\">\n    <button type=\"button\" class=\"btn-add-item btn-success btn-xs\" data-item-name-list-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">Add</button>\n  </form>\n<!-- </div> -->\n";
},"useData":true});
...
var listEvents = __webpack_require__(5);
...
var listsEvents = __webpack_require__(5);
var itemsEvents = __webpack_require__(10);
// const listsApi = require('./api')
// const listsUi = require('./ui')
var showListsTemplate = __webpack_require__(24);
var showOneListTemplate = __webpack_require__(12);
...
var onCreateSuccess = function onCreateSuccess(data) {
  ...
  var showOneListHTML = showOneListTemplate({ list: store.list });
...
var addEventsHandlers = function addEventsHandlers() {
...
var getOneListSuccess = function getOneListSuccess(data) {
  store.list = data.list;
  store.items = data.list.items;
};
...
var onDeleteSuccess = function onDeleteSuccess(id) {
...
module.exports = {
  ...
  onSuccess: onSuccess,
  getOneListSuccess: getOneListSuccess,
...
var create = function create(name, mark, listId) {
  return $.ajax({
    url: config.apiOrigin + '/items',
    method: 'POST',
    headers: {
...
var update = function update(name, mark, itemId, listId) {
  return $.ajax({
...
var getOneItemSuccess = function getOneItemSuccess(data) {
  store.item = data.item;
};
...
module.exports = {
  ...
  onUpdateSuccess: onUpdateSuccess,
  onSuccess: onSuccess,
  getOneItemSuccess: getOneItemSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 box\">\n"
    + ((stack1 = container.invokePartial(__webpack_require__(12),depth0,{"name":"add-list-template","hash":{"list":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "\n"
  ...
  return ((stack1 = container.invokePartial(__webpack_require__(41),depth0,{"name":"add-item-template","hash":{"item":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"      ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <input class=\"checkBox\" id=\"checked\" value='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.mark : stack1), depth0))
    + "' autoc omplete=\"off\" checked data-checkbox-item-id=\""
    ...
    + "\" data-list-id='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.list_id : stack1), depth0))
    + "' type=\"checkbox\"><label for='checked'>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.name : stack1), depth0))
    + "</label>\n";
},"3":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "    <input class=\"checkBox\" value='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.mark : stack1), depth0))
    + "' autocomplete=\"off\" data-checkbox-item-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" type=\"checkbox\"><label>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.name : stack1), depth0))
    + "</label>\n";
  ...
  return "<div class=\"item-name\" id='item-id-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.id : stack1), depth0))
    + "'>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.mark : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "  <div class=\"btn-item\">\n    <button type=\"button\" class=\"btn-edit-item btn-2 btn-default btn-xs\" id=\"btn-edit-item-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-item-edit-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-item-edit-name=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.name : stack1), depth0))
    + "\" data-item-edit-list-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.list_id : stack1), depth0))
    + "\" data-item-edit-mark=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.mark : stack1), depth0))
    + "\">Edit</button>\n    <button type=\"button\" class=\"btn-delete-item btn-2 btn-danger btn-xs\" id=\"btn-delete-item-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-item-delete-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">X</button>\n\n    <!-- <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#modal-delete-confirm\">\n      X\n    </button> -->\n  </div>\n</div>\n";
},"useData":true});
